    ...
    switch (user.role) {
      case 'patient':
        return [
          ...
          { name: 'Create Ticket', href: '/patient/create-ticket', icon: 'plus' },
          { name: 'Ticket History', href: '/patient/history', icon: 'document' },
          { name: 'Settings', href: '/settings', icon: 'cog' },
        ];
      case 'admin':
        return [
          { name: 'Dashboard', href: '/admin', icon: 'home' },
          { name: 'Tickets', href: '/admin/tickets', icon: 'document' },
      ...
      case 'super':
        return [
          { name: 'Dashboard', href: '/super', icon: 'home' },
          { name: 'Hospitals', href: '/super/hospitals', icon: 'building' },
          { name: 'Users', href: '/super/users', icon: 'users' },
          { name: 'Tickets', href: '/super/tickets', icon: 'document' },
          { name: 'Analytics', href: '/super/analytics', icon: 'chart' },
          { name: 'Settings', href: '/settings', icon: 'cog' },
        ];
      default:
        return [
